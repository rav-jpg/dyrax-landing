...
export default function DyraxLandingPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <header className="sticky top-0 z-30 bg-slate-950/80 backdrop-blur border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <a
            ...
            className="bg-green-500 px-4 py-2 rounded-xl font-semibold hover:scale-105 transition"
          >
            WhatsApp
          </a>
        </div>
      ...
      <main>
            ...
            <div>
              ...
              <div className="mt-8 flex gap-4 flex-col sm:flex-row">
                <a
                  ...
                  className="bg-blue-600 px-6 py-4 rounded-2xl font-bold shadow-lg hover:scale-105 transition"
                >
                  Book Slot ₹499
                </a>
                ...
                <a
                  href="https://wa.me/918115302970?text=Hi%20I%20want%20property%20leads"
                  className="border border-white/30 px-6 py-4 rounded-2xl font-bold hover:bg-white/10"
                >
                  Chat on WhatsApp
                </a>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 py-20">
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={item}
                className="bg-white/5 p-6 rounded-2xl backdrop-blur border border-white/10 hover:scale-105 transition"
              >
        ...
        <section className="max-w-5xl mx-auto px-4 py-16">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-10 rounded-3xl text-center shadow-xl">
            ...
            <a
              href="https://rzp.io/rzp/XI8LYlK"
              className="inline-block mt-6 bg-white text-black px-6 py-3 rounded-xl font-bold hover:scale-105 transition"
            >
              Pay Now
            </a>
          </div>
        ...
        <section className="text-center py-20 bg-gradient-to-r from-blue-700 to-black">
          ...
          <div className="mt-6 flex justify-center gap-4 flex-wrap">
            ...
            <a
              href="https://wa.me/918115302970?text=Hi%20I%20want%20property%20leads"
              className="border border-white px-6 py-4 rounded-2xl"
            >
              WhatsApp
            </a>
          </div>
      ...
      <a
        href="https://wa.me/918115302970?text=Hi%20I%20want%20property%20leads"
        className="fixed bottom-5 right-5 bg-green-500 px-5 py-3 rounded-full shadow-xl font-bold"
      >
        Chat
      </a>
    </div>
